<main class="container-fluid d-flex flex-column flex-lg-row h-100 no-gutters p-0 w-100">
        ...
        <section class="align-items-center col-12 col-lg-10 content-section d-flex flex-column h-100 justify-content-center">
            ...
            <section class="col-12 p-0 m-3 bg-white content-panel">
                ...
                <header class="col-12 py-3 d-flex justify-content-between align-items-center">

                    <h6 class="m-0">Cadastro</h6>

                </header>

                <section class="col-12 d-flex justify-content-start align-items-center mt-5">

                    <form class="d-flex col-lg-4 col-12 flex-column" id="cad_product">
                        ...
                        <button class="btn btn-primary mt-4 align-self-start">Adicionar</button>
